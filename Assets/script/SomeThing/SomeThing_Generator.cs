...
public class SomeThing_Generator: MonoBehaviour
{
    public float start;
    public GameObject Something,PopUpImg;
    ...
    public AudioSource p1,p2,p3,p4;
    ...
    IEnumerator Generate_()
    {
        ...
        switch(r)
        {
            ...
            yield return new WaitForSeconds(Random.Range(1.2F /num, 2.4F /num));  //탄 생성속도 원한다면 조정
    ...
    IEnumerator TimerCor()
    {
        ...
        if (GameManager.instance.GhostCount > 0)
        {
